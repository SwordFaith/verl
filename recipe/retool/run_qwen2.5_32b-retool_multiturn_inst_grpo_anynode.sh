...
WANDB_EXPERIMENT_BASE=qwen2.5-32b_function_rm-retool-async-sgl-inst-grpo-mb-bsz${train_prompt_bsz}-n${n_resp_per_prompt}-${RESPONSE_LENGTH}-${MAX_ASSISTANT_TURNS}turns
...
if [ $RANK -eq 0 ]; then
    python3 -m verl.trainer.main_ppo \
        ...
        actor_rollout_ref.model.path=$HOME/models/Qwen/Qwen2.5-32B-Instruct \
