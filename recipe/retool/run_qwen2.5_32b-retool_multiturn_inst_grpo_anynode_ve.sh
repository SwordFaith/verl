...
WANDB_EXPERIMENT_BASE=qwen2.5-32b_function_rm-retool-async-sgl-inst-grpo-ve-bsz${train_prompt_bsz}-n${n_resp_per_prompt}-${RESPONSE_LENGTH}-${MAX_ASSISTANT_TURNS}turns
