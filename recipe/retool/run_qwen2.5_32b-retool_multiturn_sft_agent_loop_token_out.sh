...
dapo_math_17k=$DATA_ROOT/dataset/retool_src_dapo/train.parquet
aime_2024_25=$DATA_ROOT/dataset/retool_src_aime2024_25/train.parquet
...
# tool
tool_config_path=retool/sandbox_fusion_tool_config.yaml

# wandb
project_name=retool_async_rl
experiment_name=qwen2.5-32b_sft28step_agent_loop_token_out_20250703
