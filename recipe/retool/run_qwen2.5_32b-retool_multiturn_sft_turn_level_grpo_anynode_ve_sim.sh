...
WANDB_EXPERIMENT_BASE=qwen2.5-32b_function_rm-retool-async-sgl-no-mask-tun-level-clip-higher-sft_28step-grpo-sim-ve-bsz${train_prompt_bsz}-n${n_resp_per_prompt}-${RESPONSE_LENGTH}-${MAX_ASSISTANT_TURNS}turns
