...
train_prompt_bsz=${TRAIN_BATCH_SIZE:-128}
...
WANDB_EXPERIMENT_BASE=qwen2.5-7b_function_rm-retool-async-sgl-sft-no-mask-grpo-turn-level-mb-bsz${train_prompt_bsz}-n${n_resp_per_prompt}-${RESPONSE_LENGTH}-${MAX_ASSISTANT_TURNS}turns
