...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/user/longxiang1/models/swordfaith/ReTool-Qwen3-4B-SFT-cold-started \
    ...
    trainer.experiment_name='qwen3-4b_function_rm-retool-async-sgl-n8-v2505270100' \
